<x-layout>
    ...
    <x-slot name="content">
      <div class="container mt-5">
        ...
        <div class="row text-white mb-5">
         <p class="mx-auto mb-5">
          Do You have question? Please do not hesitate to contact. I will come back to you within a matter of hours to help you.
         </p>
               ...
               <div class="col-md-6">
                ...
                <div class="col-md-6">
                 ...
                 <div class="col-md-12 mb-3">
                  ...
                  <textarea type="text" class="form-control mt-2" id="inputTextarea" required></textarea>
                 </div>
      ...
      <div class="text-center">
        ...
        <a href="#" target="_blank"><i class="fab fa-linkedin i-color"></i></a>
      </div>
  </x-slot>
</x-layout>
