    ...
    <div class="container mt-5">
      ...
      <div class="row text-center text-white mb-5">
        <div class="col-sm-4">
          ...
          <h3>SEO</h3>
          <P class="ss-color">Lorem ipsum dolor sit amet consectetur adipisicing elit. Pariatur, aperiam nisi!</P>
        </div>
        <div class="col-sm-4">
          <i class="fas fa-palette fa-2x mb-3 i-color"></i>
          <h3>Web Design</h3>
          <p class="ss-color">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Numquam voluptas asperiores.</p>
        </div>
        <div class="col-sm-4">
        ...
        <div class="row text-center text-white mb-5">
          <div class="col-sm-4">
           ...
           <h3>Android</h3>
           <p class="ss-color">Lorem ipsum dolor sit amet consectetur adipisicing elit. Dolor, nisi.</p>
         </div>
         <div class="col-sm-4">
